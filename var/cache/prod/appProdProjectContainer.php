...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-v-gICsDv7', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GxOTRkGi+R', 0, '1B6fsaoD2+TdUvwJnB-RD+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'fosusuarios', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ValtonsBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AppBundle\\Entity');
        $c->addDriver($b, 'ValtonsBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'ValtonsBundle' => 'ValtonsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8c0bda98146416cab01fc9684d2943155578708c09b9212562a1bbcc9ffbcadb');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('ivan.tavera19@gmail.com' => 'ivan.tavera19@gmail.com'), 'resetting' => array('ivan.tavera19@gmail.com' => 'ivan.tavera19@gmail.com'))));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('ytjsErJvTu', NULL, '1B6fsaoD2+TdUvwJnB-RD+', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/cartaporte');

        $m = new \Symfony\Component\Security\Http\AccessMap();
        $m->add($h, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $m->add($i, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $m->add($j, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('ivan.tavera19@gmail.com');
        $a->setPassword('347062@iI');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ValtonsBundle/Resources/views'), 'Valtons');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cS+8G8HIpo', 0, '1B6fsaoD2+TdUvwJnB-RD+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zHq9-IIzNk', 0, '1B6fsaoD2+TdUvwJnB-RD+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ValtonsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ValtonsBundle'),
                    'namespace' => 'ValtonsBundle',
                ),
            ); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ValtonsBundle' => 'ValtonsBundle\\ValtonsBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'fosusuarios',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'ivan.tavera19@gmail.com',
            'mailer_password' => '347062@iI',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'ivan.tavera19@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '347062@iI',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'ivan.tavera19@gmail.com' => 'ivan.tavera19@gmail.com',
            ),
